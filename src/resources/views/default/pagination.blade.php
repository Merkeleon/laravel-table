...
@if ($paginator->lastPage() > 1)
    <div class="col-xs-2" style="padding-top: 24px;">
        {{($paginator->currentPage() - 1) * $paginator->perPage()}} - {{$paginator->currentPage() * $paginator->perPage()}} {{ trans('table::table.pagination.from') }} {{$paginator->total()}} {{ trans('table::table.pagination.records') }}
    </div>
